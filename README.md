...
# Training
Note that the hyperparameters in the current version are not tuned. We will release the tuned parameters soon. For each case, the hyperparameters are slighly different. More training details and fine-tuning strategies will be updated soon.
